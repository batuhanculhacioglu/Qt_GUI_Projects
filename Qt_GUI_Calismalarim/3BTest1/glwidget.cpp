...
void GLWidget::initializeGL() {
    ...
    qglClearColor(Qt::black); // Ekran temizleme rengi siyah olarak ayarlanır
...
void GLWidget::paintGL() {
    // Her frame'in çizilmesi için çağrılır
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); // Ekran temizlenir
    glLoadIdentity(); // Model görüntüleme matrisi sıfırlanır
    gluLookAt(0, 0, 5, 0, 0, 0, 0, 1, 0); // Kamera pozisyonu ve bakış yönü ayarlanır

    // Küpü döndürmek için döndürme kodunu ekleyin
